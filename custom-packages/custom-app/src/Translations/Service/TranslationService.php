...
namespace CustomPackages\CustomApp\Translations\Service;

use CustomPackages\CustomApp\Translations\Import\TranslationsImport;
...
class TranslationService
{
    ...
    public function getCollectionFromImportedFile($file, $chosenLanguage)
    {
        if ($file->getClientOriginalExtension() !== 'xlsx') {
            abort(409, ___('custom-app', 'Unsupported file type'));
        }
        ...
        if (! $this->validImportFile($collectionFromImportedFile, $chosenLanguage)) {
            abort(409, ___('custom-app', 'Wrong syntax in your import'));
        }
